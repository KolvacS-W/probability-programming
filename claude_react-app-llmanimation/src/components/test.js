...
const sendcachedobjectsToIframe = () => {
  if (iframeRef.current?.contentWindow) {
    ...
    // const cloneableCachedObjects_noreplace = (sessionStorage.getItem('cachedobjects'));
    // console.log('sendcachedobjectsToIframe', cloneableCachedObjects.toString())
    if (cloneableCachedObjects.toString() != '[object Object]'){
      var cachedobjects = JSON.parse(cloneableCachedObjects)
    }
    else{
      cachedobjects = {}
    }
    iframeRef.current.contentWindow.postMessage({
      ...
      cachedobjects: cachedobjects, // Send the filtered cloneable reference
    }, '*');
  }
};
